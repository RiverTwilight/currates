...
function Header() {
  return _("header", {
    class: "cr-bg-themed cr-z-10"
  }, _("div", {
    class: "cr-mx-auto cr-flex cr-p-1 cr-justify-center cr-items-center"
  }, _("h1", {
    class: "cr-text-xl cr-text-white"
  }, "Preference")));
}
const App = () => {
  ...
  return _("div", {
    ...
    className: "cr-relative cr-container cr-mx-auto cr-flex"
  }, _("main", {
    className: "cr-flex-1 cr-rounded cr-overflow-hidden cr-w-full"
  }, _("br", null), _("div", {
  ...
  }, "An OpenExchange API allows you request rates more frequently. It's recommend for you to apply your own FREE API key.", _("span", {
    ...
    className: "cr-text-slate-500 cr-p-2"
  }, "Currates is totally free. Give us a star on GitHub to support us if you like it!")), _("div", {
    className: "cr-mt-4 cr-flex cr-flex-col cr-justify-center cr-items-center"
  }, _("div", {
    className: "cr-border-slate-400 cr-rounded-full"
  }, _("img", {
    height: 56,
    width: 56,
